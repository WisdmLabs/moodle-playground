...
- [`src/runtime/bootstrap.js`](https://github.com/WisdmLabs/moodle-playground/blob/main/src/runtime/bootstrap.js)
- [`src/runtime/crash-recovery.js`](https://github.com/WisdmLabs/moodle-playground/blob/main/src/runtime/crash-recovery.js)
- [`src/runtime/config-template.js`](https://github.com/WisdmLabs/moodle-playground/blob/main/src/runtime/config-template.js)
- [`php-worker.js`](https://github.com/WisdmLabs/moodle-playground/blob/main/php-worker.js)
- [`lib/moodle-loader.js`](https://github.com/WisdmLabs/moodle-playground/blob/main/lib/moodle-loader.js)
- [`scripts/generate-install-snapshot.sh`](https://github.com/WisdmLabs/moodle-playground/blob/main/scripts/generate-install-snapshot.sh)
